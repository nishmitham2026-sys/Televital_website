  ...
  useEffect(() => {
    ...
    const fetchGeoLocation = async () => {
      ...
      try {
        ...
        // Try ipwho.is (supports HTTPS, free, CORS-friendly)
        ...
        // Try ipapi.co (supports HTTPS, free tier limited to 1000 requests/day)
        ...
        // Try ipinfo.io (supports HTTPS, free, very popular)
